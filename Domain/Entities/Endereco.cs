...
/*
    Entidade de Endereço residencial do cliente — tabela própria no banco,
    referenciada pela FK EnderecoId na tabela de Cliente (1 cliente : 1
    endereço). Antes era Value Object embutido nas colunas de Cliente;
    virou entidade (tem Id próprio) para viver em tabela separada.
...
public class Endereco : Entity
{
    ...
    public Endereco(
        ...
        string cep)
    {
        AtualizarDados(logradouro, numero, complemento, bairro, cidade, uf, cep);
    }
