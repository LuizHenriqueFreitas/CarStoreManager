...
namespace CarStoreManager.Tests.Integration.Repositories
{
    public class VendedorRepositoryTests : IDisposable
    {
        ...
        public async Task GetByIdAsync_TipoDiferente_NaoRetornaOutroTipo()
        {
            ...
            var mecanico = new Domain.Entities.Oficina.Mecanico("Mec", "mec@email.com", "11922222222", "hash", 3000, EspecialidadeMecanico.Mecanica, NivelFuncionario.Junior, DateTime.Today);
        ...
        public async Task GetAllAsync_ComDados_RetornaApenasVendedores()
        {
            ...
            var mecanico = new Domain.Entities.Oficina.Mecanico("Mec", "mec@email.com", "11933333333", "hash", 3000, EspecialidadeMecanico.Mecanica, NivelFuncionario.Junior, DateTime.Today);
            _context.Usuarios.Add(mecanico);
            await _context.SaveChangesAsync();
        ...
        {
            var vendedor = new Vendedor("Carlos", "carlos@email.com", "11977777777", "hash", 3000, NivelFuncionario.Junior, DateTime.Today);
        ...
        {
            var vendedor = new Vendedor(nome, email, telefone, "hash", 3000, nivel, DateTime.Today);
            await _repository.AddAsync(vendedor);
            await _repository.SaveChangesAsync();
            return vendedor;
        }
