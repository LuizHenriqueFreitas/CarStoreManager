...
public class VeiculoClienteTest
{
    ...
    {
        var act = () => new VeiculoCliente(Guid.Empty, MarcaValida, ModeloValido, CorValida, AnoValido);
    ...
    {
        var act = () => new VeiculoCliente(_clienteIdValido, marcaInvalida, ModeloValido, CorValida, AnoValido);
    ...
    {
        var act = () => new VeiculoCliente(_clienteIdValido, MarcaValida, modeloInvalido, CorValida, AnoValido);
    ...
    {
        var act = () => new VeiculoCliente(_clienteIdValido, MarcaValida, ModeloValido, corInvalida, AnoValido);
    ...
    {
        var veiculo = new VeiculoCliente(_clienteIdValido, MarcaValida, ModeloValido, CorValida, AnoValido);
