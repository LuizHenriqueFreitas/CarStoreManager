// Application/DTOs/Oficina/Componente/ComponenteDTO.cs
...
public class ComponenteDTO
{
    ...
    // Relacionamentos (apenas IDs ou resumos, se necessário)
    // public List<Guid> LotesIds { get; set; } 
    // public List<Guid> EquivalenciasIds { get; set; }
}