...
public class GerenteVendasController : ControllerBase
{
    private readonly IGerenteVendasService _service;

    public GerenteVendasController(IGerenteVendasService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Criar([FromBody] CriarGerenteVendasDTO dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Atualizar(Guid id, [FromBody] AtualizarGerenteVendasDTO dto)
    {
        dto.Id = id;
