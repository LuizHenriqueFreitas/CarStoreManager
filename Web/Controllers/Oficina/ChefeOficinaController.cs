...
public class ChefeOficinaController : ControllerBase
{
    private readonly IChefeOficinaService _service;

    public ChefeOficinaController(IChefeOficinaService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Criar([FromBody] CriarChefeOficinaDTO dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Atualizar(Guid id, [FromBody] AtualizarChefeOficinaDTO dto)
    {
        dto.Id = id;
