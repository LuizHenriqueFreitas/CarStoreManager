...
public class RecepcionistaController : ControllerBase
{
    ...
    public RecepcionistaController(IRecepcionistaService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Criar([FromBody] CriarRecepcionistaDTO dto)
    {
    ...
    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Atualizar(Guid id, [FromBody] AtualizarRecepcionistaDTO dto)
    {
        dto.Id = id;
